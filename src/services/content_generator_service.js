...
class ContentGeneratorService {
    ...
    buildPrompt(context, dictionaries, feedback) {
        ...
        **INSTRUCTIONS:**
        ...
        3. **HOOK (CRITICAL)**: Start with a compelling first phrase that makes users want to click "show more" or read further. Use surprising facts, deep empathy, or a bold claim.
        4. **EMOJI LIMIT**: Max 3 emojis per post.
        5. **VARIETY**: Each post MUST target a DIFFERENT marketing stage (rotate S1, S2, S3, S4) and use a DIFFERENT lp_section.
        6. **CTA RULE (CRITICAL)**: For high priority posts (lp_priority: high), ALWAYS include the unified tracking link: 'https://airfuture.vercel.app/go?pid=[post_id]'.
           For low priority posts, use "詳細はプロフをみてね" or "詳細はプロフィールから✨" to drive profile traffic.
           **IMPORTANT**: Never use anxiety-inducing words like "out of stock", "pre-order", or "preparing".
        7. No "AI greetings".
