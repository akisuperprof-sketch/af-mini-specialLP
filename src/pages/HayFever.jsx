...
export default function HayFever() {
    ...
    return (
        <main className="min-h-screen bg-white text-gray-900 overflow-x-hidden font-sans">
            ...
            {/* Hero Section */}
            <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-yellow-50 to-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 z-10 relative text-center">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h1 className="text-4xl md:text-7xl font-bold mb-6 text-gray-900 tracking-tight leading-none">
                            家に帰っても、<br />
                    ...
                    >
                        <img
                            ...
                            className="w-full h-64 md:h-80 object-cover rounded-3xl shadow-2xl opacity-90 hover:scale-105 transition-transform duration-700"
                        />
                        <p className="mt-4 text-xs text-gray-400">※花粉の電子顕微鏡イメージ</p>
                    </motion.div>

                    <div className="flex flex-col md:flex-row gap-4 justify-center">
                        <Button onClick={handleCTAClick} className="bg-white text-gray-900 border border-gray-200 px-8 py-4 text-lg rounded-full shadow-sm hover:shadow-md transition-all">
                            AirFuture mini の詳細を見る
                            <ChevronRight className="ml-2 h-5 w-5" />
                        </Button>
                        <Button onClick={() => trackBuy('hero')} className="bg-black text-white hover:bg-gray-800 px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center">
                            今すぐ購入する
                            <ChevronRight className="ml-2 h-5 w-5" />
                        </Button>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 max-w-6xl mx-auto">
                        <div className="w-full md:w-1/2">
                            ...
                            <div className="p-6 bg-red-50 rounded-xl border border-red-100">
                                <AlertTriangle className="text-red-500 w-8 h-8 mb-4" />
                                <p className="font-bold text-red-700">一般的な空気清浄機の弱点</p>
            ...
            <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-xl">
                        <span className="inline-block py-1 px-3 rounded-full bg-blue-500/20 text-blue-300 text-xs font-bold mb-6 border border-blue-500/30">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="bg-white/10 backdrop-blur p-4 rounded-xl border border-white/10 text-center">
                                ...
                                <p className="font-bold">シールド効果</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur p-4 rounded-xl border border-white/10 text-center">
                                <XCircle className="w-8 h-8 mx-auto mb-2 text-blue-400" />
                                <p className="font-bold">付着菌も除去</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-5xl mx-auto">
                        <div className="p-8 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
                            <h3 className="text-xl font-bold mb-2">超小型・軽量</h3>
                            <p className="text-gray-600">わずか750g。デスクや枕元、どこでも置けるハガキサイズ。</p>
                        </div>
                        <div className="p-8 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
                            <h3 className="text-xl font-bold mb-2">フィルター交換不要</h3>
                            <p className="text-gray-600">面倒な掃除や交換コストはゼロ。ずっと清潔に使えます。</p>
                        </div>
                        <div className="p-8 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300">
                            <h3 className="text-xl font-bold mb-2">静音設計</h3>
                            <p className="text-gray-600">眠りを妨げない静けさで、24時間あなたを守り続けます。</p>
                        </div>
                    </div>
                </div>
            </section>
